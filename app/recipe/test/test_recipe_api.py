...
class PublicTestRecipeAPI(TestCase):
    """Tests unauthenticate requests for the recipe api"""
...
class PrivateTestRecipeAPI(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email='user1@example.com', password='pass123')
    ...
    def test_update_user_returns_error(self):
        """Test updating error results in error"""
        new_user = create_user(email="update@email.com", password='pass1230')
        recipe = create_recipe(user=self.user)
    ...
    def test_recipe_other_users_recipe_error(self):
        """Deleting other user recipe produces error"""
